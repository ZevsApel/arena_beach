        ...
        <div className="sure_modal__container">
            <div className="sure_modal__block">
                ...
                <div className="sure_modal__buttons_block">
                    <button className="sure_modal__decline action-button" onClick={handleDecline}>Отменить</button>
                    <button className="sureModal__accept action-button" onClick={handleAccept}>Подтвердить</button>
                </div>
